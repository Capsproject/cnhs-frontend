        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div>
              ...
              <div className="mt-5">
                ...
                <p className="mt-2 text-base text-gray-500">
                  ...
                  learner.
                  <br />
                  Administrator and Staff, as stewards of the institution, ensure an eligible and supportive environment for effective learning to happen.
                  <br />
            ...
            <div>
              ...
              <div className="mt-5">
                <h3 className="text-lg font-medium text-gray-900">Core Values</h3>
                <p className="mt-2 text-base text-gray-500">
                  Maka-Diyos
                  <br />
                  Maka-Tao
